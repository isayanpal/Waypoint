      ...
      <div className="flex gap-[14px]">
        ...
        <div className="min-w-0 flex-1">
          <div className="mb-[7px] flex flex-wrap items-center gap-[9px]">
            ...
            {project.difficulty && (
              <div className="whitespace-nowrap rounded-full bg-[#F1F1F3] px-[8px] py-[2px] text-[9.5px] font-bold text-[#54545C]">
                {project.difficulty}
              </div>
            )}
            {project.timeline && (
          ...
          <div className="mb-3 max-w-[640px] text-[12.5px] leading-[1.55] text-[#3F3F46]">
          ...
          {project.stack.length > 0 && (
            <div className="mb-3 flex flex-wrap gap-[5px]">
              {project.stack.map((chip) => (
                <div
                  key={chip}
                  className="whitespace-nowrap rounded-[5px] bg-[#F1F1F3] px-[8px] py-[2px] text-[9.5px] font-semibold text-[#54545C]"
                >
                  {chip}
                </div>
              ))}
          ...
          {project.proves && (
            <div className="mb-3 rounded-[8px] bg-wp-main px-3 py-[10px] text-[11.5px] leading-[1.55] text-[#3F3F46]">
          ...
          <Link
            ...
            className="block rounded-[8px] border border-wp-card-border py-[9px] text-center text-[12px] font-semibold hover:bg-wp-main"
          >
