      ...
      {phaseIds.map((phaseId) => {
        ...
        return (
          <Link
            ...
            className="whitespace-nowrap rounded-[5px] border border-wp-card-border bg-wp-well px-[8px] py-[2px] text-[9.5px] font-semibold text-wp-ink-secondary hover:text-wp-ink-primary"
          >
